...
public class ResourceService {
    ...
    public ResourceModel updateResource(ResourceModel res){
        ResourceModel existingRes= resourceRepository.findAllById(res.getId());
        ...
        return resourceRepository.save(existingRes);
    }
