        ...
        return(
            <div className='container'>
                <h3> 
                    ...
                    <span> 
                        <button className='btn btn-danger btn-sm' onClick={this.deleteMsg}> Delete </button>
                    </span>
                </h3>
                ...
                <div>
                    <span>
                        <input type='text' className='chatInputField' placeholder='Send a message...' value={this.state.msg} onChange={this.changeMsgHandler}/>
                    </span>
                    <button className='btn-primary sendBtn' onClick={this.sendMsg}>Send</button>
                </div>
            </div>
        );
    }
